...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Building intelligent solutions from vision to reality
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             "An AI and Software Engineer with a strong foundation in full-stack web and mobile application development, adept at building intelligent, scalable, and user-focused solutions across platforms."
            </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Think human. Code AI. Replace nothing — creating tools that amplify, not replace, human potential."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1Lqn5eri9-Y11MpwRKNA_5BztkmG4tiUs/view?usp=drive_link" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
